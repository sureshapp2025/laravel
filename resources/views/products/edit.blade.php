                ...
                <div class="card-body p-3 p-md-4">
                    <form action="{{ route('products.update',$product->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="name" type="text" name="name" value="{{ $product->name }}" placeholder="Product Name">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="detail" name="detail" placeholder="Product Details" rows="5">{{ $product->detail }}</textarea>
                        </div>
