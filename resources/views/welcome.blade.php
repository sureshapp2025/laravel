                ...
                <div class="col-md-10 text-center">
                    ...
                    <div class="row g-4 text-start">
                        <div class="col-md-4">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body p-4">
                                    <h3 class="h5 fw-bold"><i class="bi bi-shield-check text-primary me-2"></i> RBAC</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body p-4">
                                    <h3 class="h5 fw-bold"><i class="bi bi-box-seam text-primary me-2"></i> Inventory</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body p-4">
                                    <h3 class="h5 fw-bold"><i class="bi bi-lightning text-primary me-2"></i> Fast</h3>
