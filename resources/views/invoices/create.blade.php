<x-app-layout>
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="h3 mb-1 text-gray-800 fw-bold">Create Tax Invoice</h2>
                <p class="text-muted mb-0">Generate a new tax invoice, link it to bookings, and compute GST details.</p>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select name="invoice_type" class="form-select">
                                <option value="TaxInvoice" selected>Tax Invoice</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="invoice_category" class="form-control" value="Standard" placeholder="e.g. Standard, Export">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Invoice Date <span class="text-danger">*</span></label>
                            <input type="date" name="billdate" id="billdate" class="form-control" value="{{ date('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Invoice No. <span class="text-muted fs-8">(Leave blank to auto-generate)</span></label>
                            <input type="text" name="billno" class="form-control" placeholder="Ex: CSHL26270001">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="acode" id="acode" class="form-control" readonly required>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label fw-semibold">Credit Days</label>
                            <input type="number" name="credit_days" id="credit_days" class="form-control" min="0" value="30">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="po_supply" id="po_supply" class="form-control" placeholder="State/Country" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="aline1" id="aline1" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Address Line 2</label>
                            <input type="text" name="aline2" id="aline2" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <div class="row g-2">
                                <div class="col-6">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="state_code" id="state_code" class="form-control" placeholder="Ex: 33">
                        </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body pt-0">
                    <div class="row g-3">
                        ...
                        <input type="hidden" name="booking_no" id="booking_no_hidden">

                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Proforma Date</label>
                            <input type="date" name="proforma_invoice_date" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Proforma Invoice No</label>
                            <input type="text" name="proforma_invoice_no" class="form-control">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold">MBL/AWB</label>
                            <input type="text" name="guarantee_l1" id="mbl_awb" class="form-control" placeholder="MAWB/MBL">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">HBL/AWB</label>
                            <input type="text" name="guarantee_l2" id="hbl_awb" class="form-control" placeholder="HAWB/HBL">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">BE/SB No.</label>
                            <input type="text" name="guarantee_l3" id="be_sb_no" class="form-control" placeholder="SB No.">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">BE/SB Date</label>
                            <input type="date" name="exten_date" id="be_sb_date" class="form-control">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Line/Vessel</label>
                            <input type="text" name="guarantee_l4" id="line_vessel" class="form-control" placeholder="Shipping/Airline & Vessel">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Origin/POL</label>
                            <input type="text" name="category" id="origin_pol" class="form-control">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Dest/POD</label>
                            <input type="text" name="stype" id="dest_pod" class="form-control">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Gr Weight</label>
                            <input type="text" name="hcode" id="gr_weight" class="form-control">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Ch Wt/Volume</label>
                            <input type="text" name="remarks" id="ch_wt_vol" class="form-control" placeholder="e.g., 500 Kgs / LCL">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="version" id="cbm" class="form-control">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.0001" name="ex_rate" id="ex_rate" class="form-control" value="1.0000" placeholder="1.0000">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-0 d-flex flex-column gap-3">
                            <div>
                                ...
                                <select name="bank" class="form-select">
                                    <option value="YES Bank" selected>YES Bank (Default)</option>
                                    @foreach ($banks as $bank)
                                        <option value="{{ $bank->CompanyName }}">{{ $bank->CompanyName }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="hcode" class="form-select">
                                    <option value="E-Signature" selected>E-Signature (Default)</option>
                                    @foreach ($signatures as $sig)
                                        <option value="{{ $sig->CompanyName }}">{{ $sig->CompanyName }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="flex-grow-1">
                                <label class="form-label fw-semibold">Remarks</label>
                                <textarea name="remarks" class="form-control h-100" rows="3" placeholder="Enter terms, conditions, or general remarks..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex flex-column gap-2.5">
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    ...
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="total_non_tax" id="total_non_tax" class="form-control text-end fw-bold bg-light" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    <span class="text-muted fw-semibold">Total Taxable Amount:</span>
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="total_tax" id="total_tax" class="form-control text-end fw-bold bg-light" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    <span class="text-muted fw-semibold">IGST Value:</span>
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="igst_value" id="igst_value" class="form-control text-end fw-bold bg-light text-danger" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    <span class="text-muted fw-semibold">CGST Value:</span>
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="cgst_value" id="cgst_value" class="form-control text-end fw-bold bg-light text-warning" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    <span class="text-muted fw-semibold">SGST Value:</span>
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="sgst_value" id="sgst_value" class="form-control text-end fw-bold bg-light text-warning" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2 bg-light p-2 rounded">
                                    ...
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="total" id="total_sum" class="form-control text-end fw-bold border-0 bg-transparent text-dark" value="0.00" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    ...
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="round_off" id="round_off" class="form-control text-end fw-bold bg-light text-muted" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2 bg-primary bg-opacity-10 p-2 rounded">
                                    ...
                                    <div style="width: 180px;">
                                        <input type="number" step="1" name="grand_total" id="grand_total" class="form-control text-end fw-extrabold fs-5 text-primary border-primary border-2" value="0" readonly>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                    <span class="text-muted fw-semibold text-success">Advance Paid:</span>
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="advance" id="advance" class="form-control text-end fw-bold border-success text-success" value="0.00" placeholder="0.00">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center bg-danger bg-opacity-10 p-2 rounded">
                                    ...
                                    <div style="width: 180px;">
                                        <input type="number" step="0.01" name="balance" id="balance" class="form-control text-end fw-bold text-danger bg-transparent border-0" value="0.00" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="status_unpaid" value="UnPaid" checked>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-2 fw-bold shadow-sm">
                            <i class="fas fa-save me-1.5"></i> Save Invoice
                        </button>
                    </div>
                </div>
            </div>
    ...
    <!-- JAVASCRIPT LOGIC -->
    <script>
        // 1. Storage for dynamic particulars line items
        let particularsList = [];
        ...
        function calculateItemGst(item) {
            ...
            if (baseTax > 0) {
                if (clientStateCode === BUSINESS_STATE_CODE) {
                    // SAME STATE: CGST + SGST apply (each is GST rate / 2)
                    ...
                    // DIFFERENT STATE / OUT OF INDIA: IGST applies
                    item.cgst = 0;
                    item.sgst = 0;
        ...
        function recalcAllInvoiceTotals() {
            ...
            // Recalculate individual rows first (since state code or billing rules could change)
        ...
        // Edit row (populate fields back to bottom editor)
        ...
        // Decimal-only validation on inputs
